...
@mock.patch("crawlinsta.collecting.collect_tagged_posts_of_user.time.sleep", return_value=None)
...
@mock.patch("crawlinsta.collecting.collect_tagged_posts_of_user.time.sleep", return_value=None)
@mock.patch("crawlinsta.collecting.collect_tagged_posts_of_user.search_request", return_value=None)
@mock.patch("crawlinsta.collecting.collect_tagged_posts_of_user.logger")
def test_collect_tagged_posts_of_user_no_posts(mocked_logger, mocked_search_request, mocked_sleep):
