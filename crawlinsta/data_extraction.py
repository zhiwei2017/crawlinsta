...
def extract_id(info_dict: Dict[str, Any]) -> Union[str, None]:
    ...
    Examples:
        ...
        None
    """
    id_value = info_dict.get("pk") or info_dict.get("id")
    return id_value if id_value is None else str(id_value)
...
def extract_music_info(music_info_dict: Dict[str, Any]) -> MusicBasicInfo:
    ...
    Returns:
        MusicBasicInfo: The extracted music information.
    ...
    if music_info_dict["music_asset_info"].get("display_artist"):
        artist = UserProfile(id=None,
                             username="",
                             fullname=music_info_dict["music_asset_info"]["display_artist"],
                             profile_pic_url="",
                             is_private=None,
                             is_verified=None)
...
def extract_sound_info(sound_info_dict: Dict[str, Any]) -> MusicBasicInfo:
    ...
    Returns:
        MusicBasicInfo: The extracted sound information.
    ...
    music = MusicBasicInfo(id=sound_info_dict["audio_asset_id"],
                           ...
                           artist=ig_artist,
                           title=sound_info_dict.get("original_audio_title", "Original audio"),
...
def extract_post(post_info_dict: Dict[str, Any]) -> Post:
    ...
    post = Post(id=extract_id(post_info_dict),
                ...
                urls=post_urls,
                like_count=post_info_dict.get('like_count', 0),
                comment_count=post_info_dict.get('comment_count', 0),
                music=music)
    return post
