...
from crawlinsta.collecting.media import download_media
...
@mock.patch("crawlinsta.collecting.media.time.sleep", return_value=None)
...
@mock.patch("crawlinsta.collecting.media.time.sleep", return_value=None)
@mock.patch("crawlinsta.collecting.media.search_request", return_value=None)
