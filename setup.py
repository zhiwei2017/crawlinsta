...
# Package meta-data.
NAME = 'crawlinsta'
SHORT_DESCRIPTION = "A python package for crawling instagram based on selenium."
URL = "https://github.com/zhiwei2017/crawlinsta"
AUTHOR = 'Zhiwei Zhang'
...
setup(name=NAME,
      ...
      license=LICENSE,
      url=URL,
      packages=find_packages(include=["crawlinsta*"],
                             exclude=["tests*", "docs*"]),
